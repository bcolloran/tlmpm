...
* break up `substep()` kernel into one kernel per step. This will make the transition to TLMPM clearer later
* remove vsync so that the sim runs as fast as it can. This will make it easier to compare performance down the road. 
"""
import numpy as np
