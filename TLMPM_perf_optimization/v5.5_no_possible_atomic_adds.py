...
def p2g():
    ...
    for i, j in grid_m:
        ...
        for f_off, g_off in ti.static(ti.ndrange(4, 4)):
            ...
            grid_mv[i, j] = grid_mv[i, j] + weighted_mass * v[f, g]
            ...
            grid_f[i, j] = grid_f[i, j] + force_external + force_internal
        if grid_m[i, j] > 0:
...
def g2p():
    for f, g in x_config:
        ...
        for i_off, j_off in ti.static(ti.ndrange(2, 2)):
            ...
            F[f, g] = F[f, g] + dt * v_ij.outer_product(weight_grad)
            ...
            x_world[f, g] = x_world[f, g] + dt * weight * v_ij
